...
**Dependencies for compilation:** Nvidia CUDA toolkit 12.9 or higher; OpenCV 4.0 or higher; C++ compiler with standard 17 support; Microsoft Visual Studio 2017 or higher; glib v2.35 or higher; QT6.

**Dependencies for executing the shipped binaries:** Nvidia GPU drivers supporting CUDA 12.9 or higher; \hl{glib v2.35 or higher;} Microsoft Visual Studio 2017 or higher runtime libraries.
